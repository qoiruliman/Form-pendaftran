...
form.addEventListener("submit", async function (e) {
  ...
  try {
    ...
    // <a href="https://chat.whatsapp.com/" class=" d-flex align-items-center jus" target="_blank">Klik di sini untuk
    //     info lebih
    //     lanjut.</a>`;
    //   notif.innerHTML = `Selamat, Anda berhasil mendaftar. Silakan masuk ke discord lks. <br>
    // <a href="https://discord.gg/" class=" d-flex align-items-center jus" target="_blank">Klik di sini untuk
    //     info lebih
    //     lanjut.</a>`;
    //   form.reset();
    // } else {
